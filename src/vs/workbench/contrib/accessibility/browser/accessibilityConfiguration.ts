...
/** Notely: speech contrib removed — no dynamic voice settings. */
export class DynamicAccessibilityConfiguration extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.dynamicAccessibilityConfiguration';
}
