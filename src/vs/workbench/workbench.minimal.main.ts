...
// NOTELY: Disabled DiffEditor to save memory
...
// Notely: File/Edit/View menus in minimalEditorMenus.contribution.ts (no upstream menubar)
...
// NOTELY: Disabled TreeSitter to save WASM memory overhead
...
import { IIgnoredExtensionsManagementService, IgnoredExtensionsManagementService } from '../platform/userDataSync/common/ignoredExtensions.js';
